...
def custom_insert(input_list, index, value):
    ...
    values_after_insert = input_list[index:]
    
    while len(input_list) > index:
        del input_list[index]
    input_list.append(value)
    input_list.extend(values_after_insert)
...
def custom_reverse(input_list):
    ...
    input_list_copy = input_list[::-1]
    max_index = len(input_list)
    index = 0

    while index < max_index:
        input_list[index] = input_list_copy[index]
